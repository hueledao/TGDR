...
if __name__ == "__main__":
  ...
  parser.add_argument("--support_dreambooth", action="store_true", default=True)
  parser.add_argument("--support_finetuning", action="store_true", default=True)
  parser.add_argument("--support_dropout", action="store_true", default=True)
